...
const initialState =  {
    ...
    "Cheezy Treats": [
        ["/assets/img/cheezytreats/chees1.webp", "Cheezious Special", "Delicious Special Chicken with Black Olives, Sausages and Bell Pepper", "1450.00",{"Variation":{"Regular":"1450.00","Large":"1850.00","Party":"2900.00",Required:true,type:"radio"},"Extra Topping":{"Chicken Regular":"120.00","Cheese Regular":"120.00",Required:false,type:"check"}}],
        ["/assets/img/cheezytreats/chees2.webp", "Behari Kebab", "Enjoy Special Chicken Bihari Kabab, Grilled Chicken with Onion Jalapenos and Ginger Garnishing", "1450.00",{"Variation":{"Regular":"1450.00","Large":"1850.00","Party":"2900.00",Required:true,type:"radio"},"Extra Topping":{"Chicken Large":"180.00","Cheese Large":"180.00",Required:false,type:"check"}}],
        ["/assets/img/cheezytreats/chees3.webp", "Chicken Extreme", "Combination Of 3 Flavors of Chicken with Onion Bell Pepper, Green Olives, Mushrooms and Special Sauce", "1450.00",{"Variation":{"Regular":"1450.00","Large":"1850.00","Party":"2900.00",Required:true,type:"radio"},"Extra Topping":{"Chicken Large":"180.00","Cheese Large":"180.00",Required:false,type:"check"}}],
    ],
    "Sandwiches & Platters": [
        ["/assets/img/sooper/sop1.webp", "Special Roasted Platter", "4 Pcs Behari Rolls, 6pcs Wings Served with Fries & Sauce", "1080.00"],
        ...
        ["/assets/img/sooper/sop3.webp", "Classic Roll Platter", "4Pcs Behari Rolls, 4pcs Arabic Rolls Served with Fries & Sauce", "1080.00"],
    ],
    "Pizza Deals": [
        ...
        ["/assets/img/deals/deal2.webp", "Regular Pizza Deal", "1 Regular Pizza and 2 Regular Drinks.", "1350.00"],
        ["/assets/img/deals/deal3.webp", "Large Pizza Deal", "Any Flavor From Local Love Or Over the Sea Flavor Category & 1 Liter Drink", "1790.00"],
    ],
    "Special Pizza": [
        ["/assets/img/special/spec1.webp", "Crown Crust", "Scrumptious Pizza with A Yummy Blend of Grilled Chicken, Olives, Onion, Capsicum and Special Sauce", "1450.00",{"Variation":{"Regular":"1450.00","Large":"1850.00","Party":"2900.00",Required:true,type:"radio"}}],
        ["/assets/img/special/spec2.webp", "Special Chicken", "Green Olives, Mushroom, Edges Filled With Cheese Or Kabab", "1500.00",{"Edge Filling":{"Kebab":"","Cheese":"",Required:true,type:"radio"},"Variation":{"Regular":"1500.00","Large":"2200.00","Party":"3200.00",Required:true,type:"radio"}}],
    ],
    "Somewhat Amazing": [
        ["/assets/img/amazing/somea1.webp", "Somewhat Amazing1", "2 Bazinga, Regular Fries, 2 Regular Drink", "1150.00"],
        ["/assets/img/amazing/somea2.webp", "Somewhat Amazing2", "2 Bazinga Burger,2 Pcs Chicken, Large Fries,2 Regular Drink", "1550.00"],
        ["/assets/img/amazing/somea3.webp", "Somewhat Amazing3", "3 Bazinga Burger, Large Fries, 1 Liter Drink", "1750.00"],
        ["/assets/img/amazing/somea4.webp", "Somewhat Amazing4", "3 Bazinga, 3 Chicken Pieces, 1 Liter Drink", "1850.00"],
    ],
    "Pastas": [
